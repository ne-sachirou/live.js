...
a;this.events=new g;this.namespaces={}}function B(a,b){var c=new f(b.selector,a);c.events.join(b.events);Object.keys(b.namespaces).forEach(function(a){c[a].join(b[a])})}function g(){n.forEach(function(a){this[a]=[]},this)}function C(a,b){this.selector=a;this.callback=b}function D(a){return n.some(function(b){return b===a})}function s(a,b,c){c=c||document;return r(v(c.querySelectorAll(a)),function(a){return a===b})}function u(a,b,c){var d,e;a=a.getBoundingClientRect();d=a.left+window.scrollX;e=a.top+
window.scrollY;return d<=b&&b<d+a.width&&e<=c&&c<e+a.height}function v(a){var b,c,d=[];b=0;for(c=a.length;b<c;++b)d.push(a[b]);return d}function r(a,b){var c,d;c=0;for(d=a.length;c<d;++c)if(void 0!==a[c]&&b(a[c]))return a[c];return null}w.live=f;var n="pointerdown pointerup pointermove pointerover pointerout pointercancel pointerenter pointerleave keydown keyup keypress mousemove mouseover mouseout mousedown mouseup click dblclick".split(" "),l=0,m=0,h=0,k=0;document.body.addEventListener("pointermove",
...
c))};f.prototype={on:function(a,b,c){a=a.trim().toLowerCase();a=a.split(/\s+/);c?(this.namespaces[c]||(this.namespaces[c]=new g),a.forEach(function(a){this.namespaces[c][a].push(b)},this)):a.forEach(function(a){this.events[a].push(b)},this);return this},off:function(a,b){var c,d=this;if(!a&&!b)return this.events=new g,this.namespaces={},this;a=a.trim().toLowerCase();c=a.split(/\s+/);if(1===c.length&&D(c[0]))return void 0!==b?c.forEach(function(a){this.namespaces[b][a]=[]},this):(this.events[a]=[],
Object.keys(this.namespaces).forEach(function(a){c.forEach(function(b){d.namespaces[a][b]=[]})})),this;b=a;this.namespaces[b]=new g;return this}};q.prototype={on:function(a,b,c){f.prototype.on.call(this,a,b,c);return this},off:function(a,b){f.prototype.off.call(this,a,callback,b);return this}};g.prototype={join:function(a){var b=this;Object.keys(this).forEach(function(c){b[c]=b[c].concat(a[c])});return this}}})(this);
